...
[ -f "$home_source/.codex/dotfiles-mcp.config.toml" ] || die "missing Codex MCP config"
...
create_symlink "$home_source/.codex/dotfiles-mcp.config.toml" "$HOME/.codex/dotfiles-mcp.config.toml"
