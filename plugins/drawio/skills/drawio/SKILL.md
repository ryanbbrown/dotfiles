...
`references/mermaid-reference.md` is included from upstream for comparison with the MCP variants, but this skill should still generate native draw.io XML directly.
